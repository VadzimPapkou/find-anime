...
* maintenance tags
    ...
    * TO BE MOVED TO CHARACTER
        ...
        * royal guard -- TO BE SPLIT AND DELETED
        * ruthless
        * sarcastic
        * school swimsuit
        * scooter
        ...
        * warrior
        * weaponized baseball bat
        * weaponized fork
        * weaponized paper fan
        * weird eyes
        * whale
        * wings
        * xenophobia
    ...
    * TO BE MOVED TO EPISODE
        ...
        * lap pillow
        * late for school
        * live-action closing -- TO BE MOVED AND DELETED
        * lottery wheel
        * mountain-trip
        * New Year`s Day
        * omiai
        * omimai
        * OP and ED sung by cast
        * oppai pillow
...
* themes
    ...
    * immortality
    * impending death -- TO BE SPLIT AND DELETED
    * imperialism
    * infidelity
        * netorare
        * netori
    ...
    * the arts
        ...
        * performance
            ...
            * kabuki
        * photography
    * the effects of time and distance on human relationships
    * the power of love
    * training
    * utopia
...
* ungrouped
    ...
    * half-yukionna
    * heroes party
    * historical asia ambience
    * Historical characters assemble
    * Hokkaido dialect
    * Hokuriku dialect
    * hybrid of few species
    * hyperhidrosis
    * ice hockey
    * idealistic
    * impaired mobility
    ...
    * netorase
    * Nigerian
    * non-chronological release
    * one vs army
    * OP and ED have swapped order
    * opportunistic
    * outdoor
    * overknee socks
    * panty theft
    * paper talisman magic
    * police procedural
    * polyamory
    * production committee
    * projectile weapon marksmanship
    * prudish
    * pubic hair shaving
    * puzzles
    * racket
...
* unsorted
    * age change
    * aggressive plants
    * animal transforms into weapon
    * art nouveau
    * battlefield of dreams
    * butchered foreign languages
    * character related tags which need deleting or merging
        ...
        * scary dad
        * seeking protagonist
        * skilled main character
        * sudden loli companion appearance
        * troubled male lead
    ...
    * tactics
    * time dilation
    * transforming guardian
    * transforming weapons
    * trapped
    * tuning
    * twisted love
    * ukiyo-e
    * undefeatable spaceship
    * undercover
    * unintentional comedy
    * unlikely duo
    * world government
    * you`re my hidden weapon!
